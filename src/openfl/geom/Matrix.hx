...
class Matrix
{
	...
	**/
	...
	{
		Geometry.setMatrix(this, a, b, c, d, tx, ty);
	}
	...
	**/
	public function clone():Matrix
	{
		...
		Geometry.copyMatrix(output, this);
		return output;
	}
	...
	**/
	...
	{
		Geometry.multiplyMatrix(this, m, this);
	}
	...
	**/
	public function copyColumnFrom(column:Int, vector3D:Vector3D):Void
	{
		...
		{
			Geometry.copyMatrixColumnFromVector3(this, column < 0 ? 2 : column, vector3D);
		}
	}
	...
	**/
	public function copyColumnTo(column:Int, vector3D:Vector3D):Void
	{
		...
		{
			Geometry.copyMatrixColumnToVector3(vector3D, column < 0 ? 2 : column, this);
		}
	}
	...
	**/
	...
	{
		Geometry.copyMatrix(this, sourceMatrix);
	}
	...
	**/
	public function copyRowFrom(row:Int, vector3D:Vector3D):Void
	{
		...
		{
			Geometry.copyMatrixRowFromVector3(this, row, vector3D);
		}
	}
	...
	**/
	public function copyRowTo(row:Int, vector3D:Vector3D):Void
	{
		...
		{
			Geometry.copyMatrixRowToVector3(vector3D, row < 0 ? 2 : row, this);
		}
	}
	...
	**/
	...
	{
		Geometry.setTransformMatrix(this, scaleX, scaleY, rotation, tx, ty);
	}
	...
	**/
	...
	{
		Geometry.setGradientTransformMatrix(this, width, height, rotation, tx, ty);
	}
	...
	**/
	public function deltaTransformPoint(point:Point):Point
	{
		...
		Geometry.matrixTransformVector(output, this, point);
		return output;
	}
	...
	**/
	...
	{
		return matrix != null && Geometry.equalsMatrix(this, matrix);
	}
	...
	**/
	...
	{
		Geometry.setMatrixIdentity(this);
	}
	...
	**/
	...
	{
		Geometry.inverseMatrix(this, this);
		return this;
	}
	...
	**/
	...
	{
		Geometry.rotateMatrix(this, this, theta);
	}
	...
	**/
	...
	{
		Geometry.scaleMatrix(this, this, sx, sy);
	}
	...
	**/
	...
	{
		var output = new Point();
		Geometry.matrixTransformPoint(output, this, pos);
		return output;
	}
	...
	**/
	...
	{
		Geometry.translateMatrix(this, this, dx, dy);
	}
	...
	{
		Geometry.inverseMatrixTransformPoint(point, this, point);
	}
	...
	{
		Geometry.matrixTransformPoint(point, this, point);
	}
	...
	{
		Geometry.translateMatrixByVectorXY(this, this, px, py);
	}
}
#else
