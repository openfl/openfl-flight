...
class Point
{
	...
	**/
	public function add(v:Point):Point
	{
		...
		Geometry.addVector2(output, this, v);
		return output;
	}
	...
	**/
	...
	{
		var output = new Point();
		Geometry.copyVector2(output, this);
		return output;
	}
	...
	**/
	...
	{
		Geometry.copyVector2(this, sourcePoint);
	}
	...
	**/
	...
	{
		return Geometry.getVector2Distance(pt1, pt2);
	}
	...
	**/
	...
	{
		return toCompare != null && Geometry.equalsVector2(this, toCompare);
	}
	...
	**/
	...
	{
		var output = new Point();
		Geometry.interpolateVector2(output, pt2, pt1, f);
		return output;
	}
	...
	**/
	...
	{
		Geometry.scaleVector2ToLength(this, this, thickness);
	}
	...
	**/
	...
	{
		Geometry.offsetVector2(this, this, dx, dy);
	}
	...
	**/
	...
	{
		var output = new Point();
		Geometry.setVector2FromPolar(output, len, angle);
		return output;
	}
	...
	**/
	...
	{
		Geometry.setVector2(this, xa, ya);
	}
	...
	**/
	...
	{
		var output = new Point();
		Geometry.subtractVector2(output, this, v);
		return output;
	}
	...
	**/
	...
	{
		return Geometry.getVector2Length(this);
	}
}
#else
