...
class Rectangle
{
	...
	**/
	...
	{
		Geometry.setRectangle(this, x, y, width, height);
	}
	...
	**/
	public function clone():Rectangle
	{
		...
		Geometry.copyRectangle(output, this);
		return output;
	}
	...
	**/
	...
	{
		return width > 0 && height > 0 && Geometry.containsRectanglePointXY(this, x, y);
	}
	...
	**/
	public function containsRect(rect:Rectangle):Bool
	{
		...
		{
			return Geometry.enclosesRectangle(this, rect);
		}
	...
	**/
	...
	{
		Geometry.copyRectangle(this, sourceRect);
	}
	...
	**/
	...
	{
		return toCompare != null && Geometry.equalsRectangle(this, toCompare);
	}
	...
	**/
	...
	{
		Geometry.inflateRectangle(this, this, dx, dy);
	}
	...
	**/
	...
	{
		var output = new Rectangle();
		if (width >= 0 && height >= 0 && toIntersect.width >= 0 && toIntersect.height >= 0)
		{
			Geometry.computeRectangleIntersection(output, this, toIntersect);
			return output;
		}
		...
		Geometry.setRectangle(output, x0, y0, x1 - x0, y1 - y0);
		return output;
	}
	...
	**/
	public function intersects(toIntersect:Rectangle):Bool
	{
		if (width >= 0 && height >= 0 && toIntersect.width >= 0 && toIntersect.height >= 0)
		{
			return Geometry.intersectsRectangle(this, toIntersect);
		}
	...
	**/
	...
	{
		Geometry.offsetRectangle(this, this, dx, dy);
	}
	...
	**/
	...
	{
		Geometry.offsetRectangleByPoint(this, this, point);
	}
	...
	**/
	...
	{
		Geometry.setEmptyRectangle(this);
	}
	...
	**/
	...
	{
		Geometry.setRectangle(this, xa, ya, widtha, heighta);
	}
	...
	**/
	public function union(toUnion:Rectangle):Rectangle
	{
		...
		else if (width > 0 && height > 0 && toUnion.width > 0 && toUnion.height > 0)
		{
			var output = new Rectangle();
			Geometry.mergeRectangle(output, this, toUnion);
			return output;
		}
	...
	**/
	...
	{
		Geometry.matrixTransformRectangle(rect, m, this);
	}

	// Getters & Setters
	@:noCompletion private function get_bottom():Float
	{
		return Geometry.getRectangleBottom(this);
	}

	@:noCompletion private function set_bottom(b:Float):Float
	{
		Geometry.setRectangleBottom(this, b);
		return b;
	}
	...
	{
		var output = new Point();
		Geometry.getRectangleTopLeft(output, this);
		return output;
	}

	@:noCompletion private function set_topLeft(p:Point):Point
	{
		Geometry.setRectangleTopLeft(this, p);
		return p.clone();
	}
}
#else
