...
class Vector3D
{
	...
	**/
	...
	{
		Geometry.setVector4(this, x, y, z, w);
	}
	...
	**/
	public function add(a:Vector3D):Vector3D
	{
		...
		Geometry.addVector3(output, this, a);
		return output;
	}
	...
	**/
	...
	{
		var output = new Vector3D();
		Geometry.copyVector4(output, this);
		return output;
	}
	...
	**/
	...
	{
		Geometry.copyVector3(this, sourceVector3D);
	}
	...
	**/
	...
	{
		var output = new Vector3D();
		Geometry.crossVector3(output, this, a);
		output.w = 1;
		return output;
	}
	...
	**/
	...
	{
		Geometry.subtractVector3(this, this, a);
	}
	...
	**/
	...
	{
		return Geometry.getVector3Distance(pt1, pt2);
	}
	...
	**/
	...
	{
		return Geometry.getVector3Dot(this, a);
	}
	...
	**/
	...
	{
		Geometry.addVector3(this, this, a);
	}
	...
	**/
	...
	{
		return Geometry.nearEqualsVector3(this, toCompare, tolerance) && (!allFour || Math.abs(w - toCompare.w) < tolerance);
	}
	...
	**/
	...
	{
		Geometry.negateVector3(this, this);
	}
	...
	**/
	...
	{
		return Geometry.normalizeVector3(this, this);
	}
	...
	**/
	...
	{
		Geometry.projectVector4(this, this);
	}
	...
	**/
	...
	{
		Geometry.scaleVector3(this, this, s);
	}
	...
	**/
	...
	{
		Geometry.setVector3(this, xa, ya, za);
	}
	...
	**/
	...
	{
		var output = new Vector3D();
		Geometry.subtractVector3(output, this, a);
		return output;
	}
	...
	**/
	...
	{
		return Geometry.getVector3Length(this);
	}

	@:noCompletion private function get_lengthSquared():Float
	{
		return Geometry.getVector3LengthSquared(this);
	}
